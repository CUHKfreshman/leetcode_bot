from nonebot import on_message, logger, on_type, get_bot, on_keyword
...
async def handle_general_chat(event: MessageEvent):
    ...
    # currently, QQ official sdk do not have api for listening to all group messages
    await llm_group_chat.finish("ping!")